...
sealed class CueEditViewEvent {

  data class UpdateField(
    val type: CueFieldType,
    val validationResult: ValidationResult,
  ) : CueEditViewEvent()

  data class ShowProgress(val message: Int) : CueEditViewEvent()

  data object DismissProgress : CueEditViewEvent()

  data object Dismiss : CueEditViewEvent()
}
